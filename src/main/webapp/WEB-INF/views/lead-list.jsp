...
<c:if test="${not empty msg}">
	...
	<div class="bg-secondary bg-gradient">
		...
		<div class="container p-3">
			...
			<a class="btn btn-lg btn-dark" href="lead-add">Add Lead</a> <!-- Access controlled by controller -->
	...
	<div class="container mt-5">
		<c:choose>
			<c:when test="${leads.size() > 0}">
				<form class="form-container d-flex mb-5" action="lead-search" method="GET">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<th scope="col">Actions</th> <!-- Controller/service handles access -->
						</tr>
					</thead>
					<tbody>
						<c:forEach var="lead" items="${leads}">
							<tr>
								...
								<td>${lead.email}</td>
								<td>
									<a href="lead-update?id=${lead.id}">Update</a> |
									<a class="delete" href="lead-softDelete?id=${lead.id}"
   onclick="return confirm('Do you really want to delete this lead?')">Delete</a>
