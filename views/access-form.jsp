...
<div id="accessForm">
    ...
    <form:form class="form-container" modelAttribute="access" method="post" action="${pageContext.request.contextPath}/access/save">
      ...
      <%--   <!-- Privileges Multi-Select -->
        <div class="input-group mb-3 me-5">
            <span class="input-group-text">Privileges</span>
            <form:select path="privilegeIds" cssClass="form-select" multiple="true" size="5">
                <form:options items="${allPrivileges}" itemValue="privilegeId" itemLabel="privilegeName"/>
            </form:select>
            <form:errors path="privilegeIds" cssClass="error ps-5"/>
        </div> --%>
